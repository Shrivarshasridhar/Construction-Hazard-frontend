    ...
    <div style={{ minHeight: "100vh", background: "#e8f0f7" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", overflow: "hidden" }}>
        ...
        <div style={{ width: "100%", maxWidth: "400px", background: "#ffffff", borderRadius: 16, border: "none", color: "#333", marginLeft: "3%", boxShadow: "0 10px 25px rgba(0,0,0,0.1)", padding: "2rem" }}>
          <h3 style={{ textAlign: "center", marginBottom: "1rem", color: "#1F3C88", fontWeight: 700, letterSpacing: "0.5px" }}>Register</h3>
          <p style={{ textAlign: "center", color: "#555", fontSize: "0.95rem" }}>Create your account to monitor construction site safety.</p>

          <form onSubmit={handleSubmit}>
            <div className="mb-3 mt-3">
              <label style={labelStyle}>Name</label>
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} required placeholder="Enter your name" className="form-control" style={inputStyle} />
            </div>

            <div className="mb-3">
              <label style={labelStyle}>Email address</label>
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="Enter your email" className="form-control" style={inputStyle} />
            </div>

            <div className="mb-4">
              <label style={labelStyle}>Password</label>
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="Enter your password" className="form-control" style={inputStyle} />
            </div>
          ...
          <div style={{ textAlign: "center", marginTop: "1rem" }}>
            <small style={{ color: "#555" }}>
              ...
              <Link to="/" style={{ color: "#1976d2", fontWeight: 600, textDecoration: "none" }}>
                Login here
              </Link>
            </small>
          </div>
